"""
Airflow DAG: disaster-recovery экспорт группы 'users' конфигурации Zabbix
в GitLab (раз в сутки в 21:00, без quiet period).

Регистрирует zabbix_users_to_gitlab_test и zabbix_users_to_gitlab_prod.
...
for _dag_id, _dag in build_config_dags("users").items():
