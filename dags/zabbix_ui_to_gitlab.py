"""
Airflow DAG: disaster-recovery экспорт группы 'ui' конфигурации Zabbix
в GitLab (раз в сутки в 19:00, без quiet period).

Регистрирует zabbix_ui_to_gitlab_test и zabbix_ui_to_gitlab_prod.
...
for _dag_id, _dag in build_config_dags("ui", schedule="0 19 * * *").items():
